    ...
    <div className="cat-gallery">
      <div className="cat-gallery-header">
        ...
        <p className="cat-gallery-description">
          To support our cats, we rely on donations to keep the cattery running.
          Our beloved team of Cat Angels are our monthly donors. Their
          generosity goes a long way, providing for food and medical care for
          their chosen cats.
        </p>
